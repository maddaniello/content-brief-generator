...
def main():
    ...
    <div style='text-align: center; color: #666;'>
        <p>Content Brief Generator PRO  - Crea scalette ottimizzate tramite dati SEO aggiornati in tempo reale - Sviluppato da Daniele Pisciottano e il suo amico Claude 🦕</p>
    </div>
    """, unsafe_allow_html=True)
